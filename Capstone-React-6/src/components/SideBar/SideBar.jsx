	...
	return (
		<div className="bg-[#FAFAFA]">
			...
			>
				...
				<div className="h-full justify-between px-4 py-6 overflow-y-auto ">
					<a href="#" className="flex items-center justify-center mb-5">
						<img
							src="/logo/mindease-logo.svg"
					...
					<ul className="my-20 text-body1 font-regular justify-between px-3 py-4 gap-10">
						<li>
							<a
								href="#"
								className="flex items-center p-2 text-dark-3 rounded-lg hover:bg-primary-lighter hover:text-primary-darker hover:font-semibold group ease-in-out duration-100"
							>
								<svg
									width="40"
									height="40"
									...
									className="hover:stroke-primary-darker"
								>
									<path
										d="M21.6665 20.0003C21.6665 19.0799 22.4127 18.3337 23.3332 18.3337H31.6665C32.587 18.3337 33.3332 19.0799 33.3332 20.0003V31.667C33.3332 32.5875 32.587 33.3337 31.6665 33.3337H23.3332C22.4127 33.3337 21.6665 32.5875 21.6665 31.667V20.0003Z"
										stroke="currentColor"
										strokeWidth="3"
										strokeLinecap="round"
									/>
									<path
										d="M6.6665 8.33366C6.6665 7.41318 7.4127 6.66699 8.33317 6.66699H14.9998C15.9203 6.66699 16.6665 7.41318 16.6665 8.33366V20.0003C16.6665 20.9208 15.9203 21.667 14.9998 21.667H8.33317C7.4127 21.667 6.6665 20.9208 6.6665 20.0003V8.33366Z"
										stroke="currentColor"
										strokeWidth="3"
										strokeLinecap="round"
									/>
									<path
										d="M6.6665 28.3337C6.6665 27.4132 7.4127 26.667 8.33317 26.667H14.9998C15.9203 26.667 16.6665 27.4132 16.6665 28.3337V31.667C16.6665 32.5875 15.9203 33.3337 14.9998 33.3337H8.33317C7.4127 33.3337 6.6665 32.5875 6.6665 31.667V28.3337Z"
										stroke="currentColor"
										strokeWidth="3"
										strokeLinecap="round"
									/>
									<path
										d="M21.6665 8.33366C21.6665 7.41318 22.4127 6.66699 23.3332 6.66699H31.6665C32.587 6.66699 33.3332 7.41318 33.3332 8.33366V11.667C33.3332 12.5875 32.587 13.3337 31.6665 13.3337H23.3332C22.4127 13.3337 21.6665 12.5875 21.6665 11.667V8.33366Z"
										stroke="currentColor"
										strokeWidth="3"
										strokeLinecap="round"
									/>
						...
						<li>
							...
							>
								<svg
									...
									fill="none"
									xmlns="http://www.w3.org/2000/svg"
									className="group-hover:stroke-primary-darker"
								>
									<path
										d="M11.6665 5H28.3332V14C28.3332 17.3137 25.6469 20 22.3332 20H17.6665C14.3528 20 11.6665 17.3137 11.6665 14V5Z"
										stroke="currentColor"
										strokeWidth="3"
										strokeLinecap="round"
									...
									/>
									<path
										d="M28.3335 35L11.6668 35L11.6668 26C11.6668 22.6863 14.3531 20 17.6668 20L22.3335 20C25.6472 20 28.3335 22.6863 28.3335 26L28.3335 35Z"
										stroke="currentColor"
										strokeWidth="3"
										strokeLinecap="round"
										strokeLinejoin="round"
						...
						<li>
							...
							>
								...
								>
									<path
										d="M15.0002 8.33301H10.3335C9.22893 8.33301 8.3335 9.22844 8.3335 10.333V32.9997C8.3335 34.1042 9.22893 34.9997 10.3335 34.9997H15.0002M25.0002 8.33301H29.6668C30.7714 8.33301 31.6668 9.22844 31.6668 10.333V14.9997"
										stroke="currentColor"
										strokeWidth="3"
										strokeLinecap="round"
										strokeLinejoin="round"
									/>
									<path
										d="M25.0346 33.8509L21.1922 34.6194L21.9606 30.777C21.9994 30.5834 22.0945 30.4056 22.2341 30.266L29.1667 23.3333L32.5 20L35.8114 23.3114L32.4781 26.6448L25.5456 33.5775C25.406 33.7171 25.2282 33.8122 25.0346 33.8509Z"
										stroke="currentColor"
										strokeWidth="3"
										strokeLinecap="round"
										strokeLinejoin="round"
									/>
									<path
										d="M15 7C15 5.89543 15.8954 5 17 5H23C24.1046 5 25 5.89543 25 7V11.6667H15V7Z"
										stroke="currentColor"
										strokeWidth="3"
										strokeLinecap="round"
										strokeLinejoin="round"
						...
						<li>
							...
							>
								...
								>
									<path
										d="M33.3332 16.6667V10.3333C33.3332 9.22876 32.4377 8.33333 31.3332 8.33333H8.6665C7.56193 8.33333 6.6665 9.22876 6.6665 10.3333V16.6667M33.3332 16.6667V33C33.3332 34.1046 32.4377 35 31.3332 35H8.6665C7.56193 35 6.6665 34.1046 6.6665 33V16.6667M33.3332 16.6667H6.6665M13.3332 5V11.6667M26.6665 5V11.6667"
										stroke="currentColor"
										strokeWidth="2"
										strokeLinecap="round"
									/>
